...
/*
 * Created by rishav on 11/29/2017.
 */
...
public class SpecialOffersManager {

    public void specialOffersTask(Context mContext, String tag, HashMap<String, String> hashParams) {
        ...
        Call<AbstractApiResponse> call = apiService.specialOffersResponse(hashParams);
