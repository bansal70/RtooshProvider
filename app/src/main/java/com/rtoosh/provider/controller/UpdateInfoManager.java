...
public class UpdateInfoManager {
    ...
    public void updateInfoTask(Context mContext, String tag, HashMap<String, String> hashParams) {
        ...
        Call<AbstractApiResponse> call = apiService.updateInfoResponse(hashParams);
