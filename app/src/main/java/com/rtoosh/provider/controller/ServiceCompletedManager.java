...
public class ServiceCompletedManager {
    public void completeServiceTask(Context mContext, String tag, HashMap<String, String> hashParams) {
        ...
        Call<AbstractApiResponse> call = apiService.serviceCompletedResponse(hashParams);
