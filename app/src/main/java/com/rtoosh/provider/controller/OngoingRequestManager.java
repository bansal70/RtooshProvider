...
public class OngoingRequestManager {

    public void ongoingRequestTask(Context mContext, String tag, HashMap<String, String> mapParams) {

        APIService apiService = APIClient.getClient().create(APIService.class);
        ApiCallback<OngoingRequestResponse> callback = new ApiCallback<>(tag);
        ...
        Call<OngoingRequestResponse> call = apiService.ongoingRequestResponse(mapParams);
