...
public class ServiceStartedManager {
    public void startServiceTask(Context mContext, String tag, HashMap<String, String> hashParams) {
        ...
        Call<AbstractApiResponse> call = apiService.serviceStartedResponse(hashParams);
