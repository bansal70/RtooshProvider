      ...
      /*  ImageView ivImage = view.findViewById(R.id.ivImage);
        ...
        if(position==0){
          /*  ivImage.setImageResource(R.mipmap.event_collection);
            ...
            view = inflater.inflate(R.layout.welcome_slider1, collection, false);
        }else if (position==1){
            ...
            view = inflater.inflate(R.layout.welcome_slider2, collection, false);
        }else {
           /* ivImage.setImageResource(R.mipmap.book_now);
            tvTitle.setText(R.string.book_share);
            tvDes.setText(R.string.slider_three_des);*/
            view = inflater.inflate(R.layout.welcome_slider3, collection, false);
        }
